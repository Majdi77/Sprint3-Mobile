...
public class ServiceTransporteur {
    ...
    public void ajoutTransporteur(Transporteur Transporteur) {
        ...
        String url =Statics.BASE_URL+"/ajoutjson?nom="+Transporteur.getNom()+"&description="+Transporteur.getdescription()+"&prix="+Transporteur.getprix()+"&numero="+Transporteur.getnumero()+"&img="+Transporteur.getImage(); // aa sorry n3adi getId lyheya mech ta3 user ta3 reclamation
...
//                f.setImage((obj.get("imgage").toString()));
    ...
    */
    ...
    public boolean modifierTransporteur(Transporteur Transporteur) {
        String url = Statics.BASE_URL +"/updatejson/"+Transporteur.getId()+"?"+"&nom="+Transporteur.getNom()+"&description="+Transporteur.getdescription()+"&prix="+Transporteur.getprix()+"&numero="+Transporteur.getnumero();
        req.setUrl(url);
