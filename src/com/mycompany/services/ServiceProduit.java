...
public class ServiceProduit {
    ...
    public void ajoutProduit(Produit produit) {
        ...
        String url =Statics.BASE_URL+"/ajoutjsonP?nom="+produit.getNom()+"&description="+produit.getDescription()+"&prix="+produit.getPrix()+"&quantite="+produit.getQuantite()+"&image="+produit.getImage(); // aa sorry n3adi getId lyheya mech ta3 user ta3 reclamation
    ...
    public ArrayList<Produit>affichageProduits() {
        ...
        String url = Statics.BASE_URL+"/afficherjsonP";
        req.setUrl(url);
    ...
    public boolean deleteProduit(int id ) {
        String url = Statics.BASE_URL +"/deletejsonP/"+id;
    ...
    public boolean modifierProduit(Produit produit) {
        String url = Statics.BASE_URL +"/updatejsonP/"+produit.getId()+"?nom="+produit.getNom()+"&description="+produit.getDescription()+"&prix="+produit.getPrix()+"&quantite="+produit.getQuantite();
        req.setUrl(url);
