...
public class ServiceUtilisateur {
    ...
    //Signup
    public void signup(TextField username,TextField password,TextField email,TextField confirmPassword,TextField prenom, String image, ComboBox<String> roles , Resources res ) {
        
     
        
        String url = Statics.BASE_URL+"addUserJSON/new?nom="+username.getText().toString()+"&email="+email.getText().toString()+
                "&password="+password.getText().toString()+"&roles="+roles.getSelectedItem().toString()+"&prenom="+prenom.getText().toString()+"&image="+image;
  ...
  //heki 5dmtha taw nhabtha ala description
   /* public String getPasswordByEmail(String email, Resources rs ) {
    ...
    return json;
        ...
        // edit user profil
    public static void EditUser(int id, String username, String password, String nom, String prenom) {

        String url = Statics.BASE_URL + "editProfileJson?id=" + id + "&email=" + username + "&password=" + password+ "&nom=" + nom + "&prenom=" + prenom;
