...
public class ServiceParticipant {
    ...
    public void ajoutParticipant(Participant Participant) {
        ...
        String url =Statics.BASE_URL+"/ajoutjson1?nom="+Participant.getNom()+"&prenom="+Participant.getPrenom()+"&email="+Participant.getEmail()+"&age="+Participant.getAge()+"&tel="+Participant.getTel();
...
//                f.setImage((obj.get("imgage").toString()));
    ...
    public ArrayList<Participant>affichageParticipants() {
     ...
     //   req.setUrl(url);
        ...
        req = new ConnectionRequest();
        String url = Statics.BASE_URL+"/afficherjson1?";
    ...
    */
    ...
    public boolean deleteParticipant(int id ) {
        ...
        String url = Statics.BASE_URL +"/deletejson1/"+id;
    ...
    public boolean modifierParticipant(Participant Participant) {
        String url = Statics.BASE_URL +"/updatejson1/"+Participant.getId()+"?"+"&nom="+Participant.getNom()+"&prenom="+Participant.getPrenom()+"&Email="+Participant.getEmail()+"&Age="+Participant.getAge()+"&tel="+Participant.getTel();
        req.setUrl(url);
