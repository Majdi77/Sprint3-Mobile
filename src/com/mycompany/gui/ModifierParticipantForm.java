 ...
 * @author Maram
 */
public class ModifierParticipantForm  extends BaseForm{
     Form current;
    public ModifierParticipantForm(Resources res , Participant r) {
    ...
    public ModifierParticipantForm(Resources theme) {
