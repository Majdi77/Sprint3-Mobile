 ...
 * @author 21692
 */
public class FrontEvent extends BaseForm  {
     Form current;
    public FrontEvent(Resources res ) {
    super("Newsfeed",BoxLayout.y()); //herigate men Newsfeed w l formulaire vertical
        ...
        setTitle("Yoga Evenement  date Debut 22/5/2023");
        ...
        RadioButton mesListes = RadioButton.createToggle("Participer Ici", barGroup);
        ...
        mesListes.addActionListener((e) -> {
            AjoutParticipantForm AjoutParticipantForm = new AjoutParticipantForm(res);
            AjoutParticipantForm.show();
