...
public class StatistiqueForm extends BaseForm {
    ...
    private double nbr_reservation = 14;
    private double nbr_cours = 3;
...
BaseForm form;
        ...
        addTab(swipe, res.getImage("sport.jpg"), spacer1, "Bienvenue");
        ...
        RadioButton popular = RadioButton.createToggle("Categorie Coaching", barGroup);
        popular.setUIID("SelectBar");
        RadioButton Liste = RadioButton.createToggle("RendezVous", barGroup);
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AjoutCoachingForm(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
    ...
    public void createPieChartForm() {
        ...
        double total = nbr_reservation+ nbr_cours;
        
        //values
        double prcntres = (nbr_reservation *100)/total;
        
        double prcntCours = (nbr_cours * 100)/total;
        ...
        //CREATe the chart ...
        PieChart chart = new PieChart(buildDataset("title",Math.round(prcntres),Math.round(prcntCours)), renderer);
        
        // n7oto chart fi component
        ChartComponent c  = new ChartComponent(chart);
        
        String []messages = {
            "Statistique nombre des cours % reservation"
        };
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntCours) {
        
        CategorySeries series = new CategorySeries(title);
        
        series.add("Cours",prcntCours);
