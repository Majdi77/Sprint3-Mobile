 ...
 * @author Lenovo
 */
public class ListFront extends BaseForm{
    
    Form current;
    public ListFront(Resources res ) {
          super("Newsfeed",BoxLayout.y()); //herigate men Newsfeed w l formulaire vertical
        Toolbar tb = new Toolbar(true);
        current = this ;
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle(" Mes Participants");
        ...
        mesListes.addActionListener((e) -> {
            ListFront ListParticipantForm = new ListFront(res);
...
partage.addActionListener((e) -> {
    ...
    AjoutParticipantForm ajouterParticipantForm = new AjoutParticipantForm(res);
   ...
   ArrayList<Participant> list = ServiceParticipant.getInstance().affichageParticipants();
if (!list.isEmpty()) {
    Participant dernierParticipant = list.get(list.size() - 1);
    String urlImage ="back-logo.jpg"; // ou le chemin vers l'image du participant

    Image placeHolder = Image.createImage(120, 90);
    EncodedImage enc =  EncodedImage.createFromImage(placeHolder,false);
    URLImage urlim = URLImage.createToStorage(enc, urlImage, urlImage, URLImage.RESIZE_SCALE);

    addButton(urlim, dernierParticipant, res);
    ...
    private void addButton(Image img,Participant rec , Resources res) {
        ...
        Label nomTxt = new Label("nom : "+rec.getNom(),"NewsTopLine2");
         ...
         Label emailTxt;
        emailTxt = new Label("email : "+rec.getEmail(),"NewsTopLine2");
        Label ageTxt = new Label("age : "+rec.getAge(),"NewsTopLine2");
        Label telTxt;
        telTxt = new Label("tel : "+rec.getTel(),"NewsTopLine2" );
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce Participant ?","Annuler","Oui")) {
                dig.dispose();
            }
            else {
                dig.dispose();
                ...
                if(ServiceParticipant.getInstance().deleteParticipant(rec.getId())) {
        ...
        lModifier.addPointerPressedListener(l -> {
            ...
            new ModifierFront(res,rec).show();
        });
