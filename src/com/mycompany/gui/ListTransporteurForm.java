...
public class ListTransporteurForm extends BaseForm{
    ...
    public ListTransporteurForm(Resources res ) {
        ...
        ArrayList<Transporteur>list = ServiceTransporteur.getInstance().affichageTransporteurs();
        
        for(Transporteur rec : list ) {
    ...
    private void addButton(Image img,Transporteur rec , Resources res) {
        ...
        Label numeroTxt = new Label("numero : "+rec.getnumero(),"NewsTopLine2" );
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer ce Transporteur ?","Annuler","Oui")) {
                dig.dispose();
            }
            else {
                dig.dispose();
                ...
                if(ServiceTransporteur.getInstance().deleteTransporteur(rec.getId())) {
        ...
        lModifier.addPointerPressedListener(l -> {
            ...
            new ModifierTransporteurForm(res,rec).show();
        });
